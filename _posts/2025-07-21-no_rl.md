...
**Functional reward encoding** generalizes this by defining the reward as a _functional_:
...
During unsupervised RL, the agent learns a _universal policy_ $\pi_\theta(a|s, z)$, where $z$ is a latent variable indexing diverse behaviors.
